  ...
  return (
    ...
    >
      ...
      <button
        ...
        onClick={dismiss}
        aria-label="Close"
        className="absolute top-5 right-5 sm:top-7 sm:right-7 z-20 w-11 h-11 rounded-full bg-white/10 hover:bg-white/20 backdrop-blur-sm border border-white/15 flex items-center justify-center text-cream/80 hover:text-white transition"
      >
