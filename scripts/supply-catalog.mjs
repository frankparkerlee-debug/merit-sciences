...
export const CATALOG = [
  ...
  { file: 'hydrogel-3oz',          type: 'Amorphous Hydrogel',   size: '3 oz tube',     ref: 'MY-03OZHG', hcpcs: 'A6248', cat: 'WOUND_CARE', cents: 620, box: 12, rx: false, form: 'tube', eyebrow: 'Hydrogel', blurb: 'Amorphous hydrogel to donate moisture to dry wound beds and support autolytic debridement.' },
  { file: 'silver-hydrogel-3oz',   type: 'Silver Hydrogel',      size: '3 oz tube',     ref: 'MY-03OZSH', hcpcs: 'A6248', cat: 'WOUND_CARE', cents: 980, box: 12, rx: false, form: 'tube', eyebrow: 'Hydrogel', blurb: 'Amorphous hydrogel with ionic silver for dry or minimally exuding wounds at risk of infection.' },
  { file: 'hydrogel-sheet-4x4',    type: 'Hydrogel Sheet',       size: '4" × 4"',      ref: 'MY-0404HS', hcpcs: 'A6242', cat: 'WOUND_CARE', cents: 480, box: 10, rx: false, eyebrow: 'Hydrogel', blurb: 'Hydrogel sheet for dry to lightly exuding wounds. Cooling on application.' },
  { file: 'hydrogel-gauze-4x4',    type: 'Hydrogel Gauze',       size: '4" × 4"',      ref: 'MY-0404HG', hcpcs: 'A6231', cat: 'WOUND_CARE', cents: 360, box: 10, rx: false, eyebrow: 'Hydrogel', blurb: 'Hydrogel-impregnated gauze for packing dry cavity and tunneling wounds.' },
  { file: 'collagen-gel-1oz',      type: 'Collagen Gel',         size: '1 oz tube',     ref: 'MC-01OZCG', hcpcs: 'A6011', cat: 'COLLAGEN',   cents: 2400, box: 12, rx: true, form: 'tube', eyebrow: 'Native collagen', blurb: 'Collagen in gel form for wounds where a sheet or particulate will not conform.' },

  // ââ Cleansers & skin care âââââââââââââââââââââââââââââââââââââââââââââââ
  { file: 'wound-cleanser-8oz',    type: 'Wound Cleanser',       size: '8 oz spray',    ref: 'MW-08OZWC', hcpcs: 'A6260', cat: 'WOUND_CARE', cents: 420, box: 12, rx: false, form: 'bottle', eyebrow: 'Cleanser', blurb: 'Non-cytotoxic wound cleanser spray for routine irrigation and debris removal.' },
  { file: 'saline-wash-7oz',       type: 'Sterile Saline Wash',  size: '7.1 oz',        ref: 'MW-07OZSW', hcpcs: 'A6260', cat: 'WOUND_CARE', cents: 340, box: 12, rx: false, form: 'bottle', eyebrow: 'Cleanser', blurb: 'Pressurised sterile saline for wound irrigation without additives.' },
  { file: 'barrier-film-wipes',    type: 'Skin Barrier Film',    size: 'Wipes, 30 ct',  ref: 'MW-30CTBF', hcpcs: 'A6250', cat: 'WOUND_CARE', cents: 580, box: 10, rx: false, form: 'box', sterile: false, eyebrow: 'Skin care', blurb: 'No-sting barrier film wipes to protect periwound skin from adhesive trauma and moisture.' },
  { file: 'barrier-cream-4oz',     type: 'Moisture Barrier Cream', size: '4 oz tube',   ref: 'MW-04OZBC', hcpcs: 'A6250', cat: 'WOUND_CARE', cents: 460, box: 12, rx: false, form: 'tube', sterile: false, eyebrow: 'Skin care', blurb: 'Zinc-based moisture barrier for incontinence-associated dermatitis and periwound protection.' },

  // ââ Gauze, packing & secondary ââââââââââââââââââââââââââââââââââââââââââ
  { file: 'gauze-sponge-4x4',      type: 'Gauze Sponge',         size: '4" × 4"',      ref: 'MZ-0404GSP', hcpcs: 'A6216', cat: 'WOUND_CARE', cents: 120, box: 50, rx: false, eyebrow: 'Gauze', blurb: 'Sterile gauze sponge for cleansing, packing, and secondary coverage.' },
  { file: 'petrolatum-gauze-3x8',  type: 'Petrolatum Gauze',     size: '3" × 8"',      ref: 'MZ-0308PGZ', hcpcs: 'A6222', cat: 'WOUND_CARE', cents: 280, box: 12, rx: false, eyebrow: 'Impregnated', blurb: 'Petrolatum-impregnated gauze for non-adherent coverage of donor and graft sites.' },
  { file: 'iodoform-packing',      type: 'Iodoform Packing Strip', size: '1/4" × 5 yd', ref: 'MZ-0025IP', hcpcs: 'A6222', cat: 'WOUND_CARE', cents: 340, box: 12, rx: false, form: 'roll', eyebrow: 'Impregnated', blurb: 'Iodoform-impregnated packing strip for draining sinus tracts and abscess cavities.' },
  { file: 'composite-4x4',         type: 'Composite Dressing',   size: '4" × 4"',      ref: 'MZ-0404CMP', hcpcs: 'A6203', cat: 'WOUND_CARE', cents: 240, box: 10, rx: false, eyebrow: 'Composite', blurb: 'All-in-one composite dressing: absorbent pad, contact layer, and adhesive border.' },
  { file: 'abdominal-pad-8x10',    type: 'Abdominal Pad',        size: '8" × 10"',     ref: 'MZ-0810ABD', hcpcs: 'A6254', cat: 'WOUND_CARE', cents: 200, box: 25, rx: false, eyebrow: 'Secondary', blurb: 'High-capacity abdominal pad for heavily draining wounds as a secondary dressing.' },
  ...
  { file: 'elastic-bandage-4in',   type: 'Elastic Bandage',      size: '4" × 5 yd',    ref: 'MN-04INEB', hcpcs: 'A6448', cat: 'WOUND_CARE', cents: 180, box: 10, rx: false, form: 'roll', sterile: false, eyebrow: 'Compression', blurb: 'Light-compression elastic bandage for securement and oedema management.' },
  { file: 'cohesive-wrap-4in',     type: 'Cohesive Wrap',        size: '4" × 5 yd',    ref: 'MN-04INCW', hcpcs: 'A6454', cat: 'WOUND_CARE', cents: 220, box: 12, rx: false, form: 'roll', sterile: false, eyebrow: 'Compression', blurb: 'Self-adherent cohesive wrap that sticks to itself, not to skin or hair.' },
  { file: 'undercast-padding-4in', type: 'Undercast Padding',    size: '4" × 4 yd',    ref: 'MN-04INUP', hcpcs: 'A6441', cat: 'WOUND_CARE', cents: 160, box: 12, rx: false, form: 'roll', sterile: false, eyebrow: 'Padding', blurb: 'Cotton undercast padding for pressure distribution beneath compression.' },
  { file: 'paper-tape-2in',        type: 'Paper Tape',           size: '2" × 10 yd',   ref: 'MN-02INPT', hcpcs: 'A4452', cat: 'WOUND_CARE', cents: 140, box: 12, rx: false, form: 'roll', sterile: false, eyebrow: 'Securement', blurb: 'Hypoallergenic paper tape for fragile skin and frequent dressing changes.' },
  { file: 'silicone-tape-2in',     type: 'Silicone Tape',        size: '2" × 5 yd',    ref: 'MN-02INST', hcpcs: 'A4450', cat: 'WOUND_CARE', cents: 320, box: 12, rx: false, form: 'roll', sterile: false, eyebrow: 'Securement', blurb: 'Atraumatic silicone tape for at-risk and repeatedly taped skin.' },
  ...
  { file: 'npwt-dressing-kit',     type: 'NPWT Dressing Kit',    size: 'Medium',        ref: 'MP-MEDKIT', hcpcs: 'A6550', cat: 'DME', cents: 2900, box: 5, rx: true, form: 'box', eyebrow: 'NPWT', blurb: 'Negative-pressure wound therapy dressing kit — foam, drape, and pad.' },
  { file: 'npwt-canister-250',     type: 'NPWT Canister',        size: '250 mL',        ref: 'MP-250CAN', hcpcs: 'A7000', cat: 'DME', cents: 1450, box: 5, rx: true, form: 'bottle', eyebrow: 'NPWT', blurb: 'Negative-pressure wound therapy collection canister with gel solidifier.' },
